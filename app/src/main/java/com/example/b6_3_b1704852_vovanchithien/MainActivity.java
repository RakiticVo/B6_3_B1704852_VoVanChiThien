package com.example.b6_3_b1704852_vovanchithien;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String DownloadText(String URL) {
        ...
        try {
            ...
            Log.e("Networking", e.getLocalizedMessage());return str;
        }
        return str;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText edit_img = findViewById(R.id.edt_img);
        final EditText edit_text = findViewById(R.id.edt_text);
        Button btn_img = findViewById(R.id.btn_img);
        Button btn_text = findViewById(R.id.btn_text);
        btn_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                URL = edit_img.getText().toString();
...
//        String URL = "https://imta.edu.vn/cach-cai-dat-va-su-dung-xampp/";
